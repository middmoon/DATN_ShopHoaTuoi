...
class CustomerController {
  static getMyOrders = async (req, res) => {
    new OK({
      ...
      data: await CustomerService.getMyAllOrders(req._id),
    }).send(res);
  };

  static getMyOrderById = async (req, res) => {};

  static reviewOrder = async (req, res) => {
    new OK({
      message: "review order successfully",
      data: await CustomerService.reviewOrder(req.params.orderId, req.body),
    });
  };
