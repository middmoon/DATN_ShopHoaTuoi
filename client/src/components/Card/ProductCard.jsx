      ...
      <div className="bg-white rounded-2xl shadow-md p-4 w-full flex flex-col items-center transition-transform transform hover:-translate-y-2 hover:shadow-lg border">
        <div className="relative w-full h-80">
          ...
          <ButtonAddToCard
            ...
            className="absolute bottom-2 right-2 bg-color-custom-6 text-white p-3 rounded-full hover:bg-color-custom-2  transition-all w-12 h-12 flex items-center justify-center"
          ></ButtonAddToCard>
        </div>
        <p
