...
const FlowerConsultation = () => {
  ...
  return (
    <div className="text-white p-6 rounded-lg max-w-md mx-auto">
      <h2 className="text-center text-xl font-bold mb-4 text-color-custom-1">
        TƯ VẤN CHỌN HOA TƯƠI
      </h2>

      <div className="flex flex-col gap-3">
        <div className="flex flex-col">
          <label className="mb-1 text-color-custom-1">Chủ đề</label>
          <select
            className="p-2 text-color-custom-1 bg-color-custom-4 rounded-md border"
            value={theme}
        ...
        <div className="flex flex-col">
          <label className="mb-1 text-color-custom-1">Mức giá</label>
          <select
            className="p-2 text-color-custom-1 bg-color-custom-4 rounded-md border"
            value={price}
        ...
        <button className="bg-color-custom-1 text-color-custom-4 font-bold py-2 rounded-md">
          Tìm kiếm
        </button>
      </div>
      ...
      <p className="text-sm mt-3 text-center text-black">
        *Bạn có thể gọi nhanh cho chúng tôi theo số{" "}
        <span className="text-color-custom-1 font-bold">0123 456 789</span> để
