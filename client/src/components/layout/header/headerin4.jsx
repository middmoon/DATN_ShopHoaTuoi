...
export default function HeaderIn4() {
  return (
    <div className="flex items-center justify-between px-4 sm:px-6 md:px-10 py-3 md:py-4">
      {/* Địa chỉ */}
      <div className="flex-1 font-font2 text-color-custom-1 text-left whitespace-nowrap">
      ...
      {/* Tiêu đề thương hiệu */}
      <div className="flex-1 font-font1 text-color-custom-1 text-center font-bold whitespace-nowrap">
        <a
          href="/"
      ...
      {/* Số điện thoại */}
      <div className="flex-1 font-font2 text-color-custom-1 text-right whitespace-nowrap">
