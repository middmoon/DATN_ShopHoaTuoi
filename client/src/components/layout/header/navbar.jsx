...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between text-black px-10 rounded-3xl bg-color-custom-1 z-50 border text-[10px] sm:text-xs md:text-sm lg:text-[10px] xl:text-sm">
        ...
        <ul className="flex font-font2 items-center justify-between w-1/2 mr-10 relative z-50">
          ...
          {otherCategories.length > 0 && (
            <li className="relative group">
              <button className="px-4 py-2 text-color-custom-4 font-medium transition-colors">
                Xem Thêm
              </button>
            ...
            <div className="relative">
              ...
              {isDropdownOpen && userEmail && (
                <div className="absolute right-0 mt-5 w-48 bg-white shadow-md rounded-lg py-2">
                  <a href="/profile" className="px-4 py-2 text-gray-700">
                    Tra Cứu Đơn Hàng
                  </a>
                  <button
