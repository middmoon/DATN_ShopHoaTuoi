...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between text-black px-10 rounded-3xl bg-color-custom-4 z-50 border ">
      <div className="flex justify-between w-full">
        <ul className="flex font-font2 items-center justify-between w-1/2 mr-10 relative z-50">
          {menuItems.map((item, index) => (
            <li
              key={index}
              className="relative hover:text-gray-500 cursor-pointer border-r-2 pr-4 last:border-none flex-grow text-center py-6"
        ...
        <div className="flex items-center justify-center w-1/2">
          <input
            ...
            className="bg-color-custom-4 px-4 font-font2 py-2 rounded-lg text-black border outline-none flex-grow"
          />
          <div className="flex items-center cursor-pointer hover:text-gray-500 flex-grow justify-center relative">
            <svg
          ...
          <div className="flex items-center cursor-pointer hover:text-gray-500 flex-grow justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
