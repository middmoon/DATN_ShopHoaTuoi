// #### default ->> search for default value
// ### modify ->> search for modify
...
interface MultiSelectProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "defaultValue">, VariantProps<typeof multiSelectVariants> {
  ...
  // ### modify
  /**
   * Modify to close the popover when dialog is closed
   */
      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
        ...
        <PopoverContent className="w-auto p-0" align="start" onEscapeKeyDown={() => setIsPopoverOpen(false)}>
          <Command>
            ...
            <CommandList>
              <CommandEmpty>Không tím thấy danh mục.</CommandEmpty>
              <CommandGroup>
                ...
                {options.map((option) => {
                  ...
                  return (
                    <CommandItem key={option._id} onSelect={() => toggleOption(option._id)} className="cursor-pointer">
                      <div
                        className={cn(
                          "mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary",
